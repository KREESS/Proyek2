...
class AddForeignKeysToJawabanPengguna3Table extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('jawaban_pengguna3', function (Blueprint $table) {
    ...
    public function down()
    {
        Schema::table('jawaban_pengguna3', function (Blueprint $table) {
            ...
            for ($i = 1; $i <= 20; $i++) {
                $table->dropForeign("jawaban_pengguna3_soal_tryout_id_$i_foreign");
            }
        });
    }
}
