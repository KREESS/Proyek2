...
<div class="container">
    ...
    <form action="{{ url('/materi') }}" method="POST">
        @csrf
        <div class="mb-3">
            <label for="question_type1" class="form-label">Jenis Soal</label>
            <select class="form-select" id="question_type1" name="question_type1" onchange="showAdditionalOptions()">
                <option value="">===== Pilih Jenis Soal =====</option>
                <option value="Tes Potensi Skolastik">Tes Potensi Skolastik</option>
                <option value="Tes Literasi">Tes Literasi</option>
            </select>
        </div>
        <div class="mb-3 d-none" id="additional_tps_options1">
            <label for="tps_type1" class="form-label">Pilih Kategori Tes Potensi Skolastik</label>
            <select class="form-select" id="tps_type1" name="tps_type1" onchange="showAdditionalOptions()">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_penalaran1">
            <label for="penalaran_type1" class="form-label">Pilih Kategori Kemampuan Penalaran Umum</label>
            <select class="form-select" id="penalaran_type1" name="penalaran_type1" onchange="showAdditionalOptions()">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_penalaran_induktif1">
            <label for="penalaran_induktif_detail1" class="form-label">Pilih Detail Penalaran Induktif</label>
            <select class="form-select" id="penalaran_induktif_detail1" name="penalaran_induktif_detail1">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_penalaran_deduktif1">
            <label for="penalaran_deduktif_detail1" class="form-label">Pilih Detail Penalaran Deduktif</label>
            <select class="form-select" id="penalaran_deduktif_detail1" name="penalaran_deduktif_detail1">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_penalaran_kuantitatif1">
            <label for="penalaran_kuantitatif_detail1" class="form-label">Pilih Detail Penalaran Kuantitatif</label>
            <select class="form-select" id="penalaran_kuantitatif_detail1" name="penalaran_kuantitatif_detail1">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_pemahaman_pemahaman_umum1">
            <label for="pemahaman_pemahaman_type1" class="form-label">Pilih Kategori Pengetahuan dan Pemahaman Umum</label>
            <select class="form-select" id="pemahaman_pemahaman_type1" name="pemahaman_pemahaman_type1">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_pemahaman1">
            <label for="pemahaman_type1" class="form-label">Pilih Kategori Kemampuan Memahami Bacaan dan Menulis</label>
            <select class="form-select" id="pemahaman_type1" name="pemahaman_type1">
        ...
        <div class="mb-3 d-none" id="additional_tps_suboptions_kuantitatif1">
            <label for="kuantitatif_type1" class="form-label">Pilih Kategori Pengetahuan Kuantitatif</label>
            <select class="form-select" id="kuantitatif_type1" name="kuantitatif_type1">
        ...
        <div class="mb-3 d-none" id="additional_tl_options1">
            <label for="tl_type1" class="form-label">Pilih Kategori Tes Literasi</label>
            <select class="form-select" id="tl_type1" name="tl_type1" onchange="showAdditionalOptions()">
        ...
        <div class="mb-3 d-none" id="additional_tl_suboptions_indonesia1">
            <label for="tl_indonesia_type1" class="form-label">Pilih Subkategori Literasi dalam Bahasa Indonesia</label>
            <select class="form-select" id="tl_indonesia_type1" name="tl_indonesia_type1">
        ...
        <div class="mb-3 d-none" id="additional_tl_suboptions_matematika1">
            <label for="tl_matematika_type1" class="form-label">Pilih Subkategori Penalaran Matematika</label>
            <select class="form-select" id="tl_matematika_type1" name="tl_matematika_type1">
        ...
        <div class="mb-3 d-none" id="additional_tl_suboptions_inggris1">
            <label for="tl_inggris_type1" class="form-label">Pilih Subkategori Literasi dalam Bahasa Inggris</label>
            <select class="form-select" id="tl_inggris_type1" name="tl_inggris_type1">
    ...
    <button for="nama_tombol1" type="submit" class="btn btn-primary btn-outline-dark hover-effect">Simpan Materi</button>
</form>
<br><br>
</div>
...
<script>
    function showAdditionalOptions() {
        const questionType = document.getElementById('question_type1').value;
        const tpsOptions = document.getElementById('additional_tps_options1');
        const tlOptions = document.getElementById('additional_tl_options1');
        const tpsSuboptionsPenalaran = document.getElementById('additional_tps_suboptions_penalaran1');
        const tpsSuboptionsPemahamanPemahamanUmum = document.getElementById('additional_tps_suboptions_pemahaman_pemahaman_umum1');
        const tpsSuboptionsPemahaman = document.getElementById('additional_tps_suboptions_pemahaman1');
        const tpsSuboptionsKuantitatif = document.getElementById('additional_tps_suboptions_kuantitatif1');
        const tpsSuboptionsPenalaranInduktif = document.getElementById('additional_tps_suboptions_penalaran_induktif1');
        const tpsSuboptionsPenalaranDeduktif = document.getElementById('additional_tps_suboptions_penalaran_deduktif1');
        const tpsSuboptionsPenalaranKuantitatif = document.getElementById('additional_tps_suboptions_penalaran_kuantitatif1');
        const tlSuboptionsIndonesia = document.getElementById('additional_tl_suboptions_indonesia1');
        const tlSuboptionsInggris = document.getElementById('additional_tl_suboptions_inggris1');
        const tlSuboptionsMatematika = document.getElementById('additional_tl_suboptions_matematika1');
        ...
        if (questionType === 'Tes Potensi Skolastik') {
            ...
            const tpsType = document.getElementById('tps_type1').value;
            if (tpsType === 'Kemampuan Penalaran Umum') {
                tpsSuboptionsPenalaran.classList.remove('d-none');

                const penalaranType = document.getElementById('penalaran_type1').value;
            ...
            const tlType = document.getElementById('tl_type1').value;
    ...
    document.getElementById('question_type1').addEventListener('change', showAdditionalOptions);
    // Attach event listener to update options when the TPS type changes
    document.getElementById('tps_type1').addEventListener('change', showAdditionalOptions);
    // Attach event listener to update options when the Penalaran type changes
    document.getElementById('penalaran_type1').addEventListener('change', showAdditionalOptions);
    // Attach event listener to update options when the TL type changes
    document.getElementById('tl_type1').addEventListener('change', showAdditionalOptions);
    ...
    document.getElementById('nama_tombol1').addEventListener('click', function() {
