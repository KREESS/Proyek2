...
<div class="container mt-5">
    <h1 class="text-center mb-4">Kemampuan Memahami Bacaan dan Menulis</h1>
    ...
    <div id="soalContainer" class="card mb-3">
        <div class="card-body position-relative">
            ...
            <div class="mt-3">
                <p id="soalQuestion" class="card-text">{{ $soal_all3[0]->question }}</p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        let currentIndex = 0;
        const soalCount = {!! json_encode(count($soal_all3)) !!}; // Ambil panjang array langsung dari PHP
        ...
        function showSoal(index) {
            ...
            const currentSoal = {!! json_encode($soal_all3) !!}[shuffledIndex]; // Mengambil data soal dari array yang di-shuffle
        ...
        document.getElementById('finishButton').addEventListener('click', function (event) {
            ...
            if (confirm('Apakah Anda yakin ingin menyelesaikan tes ini? Semua jawaban yang sudah Anda pilih akan dihapus.')) {
                ...
                window.location.href = "{{ route('tryout.start5') }}";
            }
        });
